...
const numeros = [19, 12, 6, -31, 45, 50, -27, 1, 9, 99, 11];
...
function valorMinimo(numeros)
    {
    let numeroMinimo=0
    const Minimo = numeros.filter((value,index,array)=>
        {
            return typeof value!=="string" ? (value<numeroMinimo ? (numeroMinimo=value) : value=numeroMinimo)  : (numeroMinimo="false");
        });
